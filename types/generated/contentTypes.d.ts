...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    translate_ua: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCertificateCertificate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    certificateFile: Schema.Attribute.Media<'files' | 'images'> &
      Schema.Attribute.Required;
    certificateNumber: Schema.Attribute.String & Schema.Attribute.Unique;
    certificateType: Schema.Attribute.Enumeration<['product', 'seller']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceUAH: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiSellerMetaSellerMeta extends Struct.CollectionTypeSchema {
  collectionName: 'seller_metas';
  info: {
    displayName: 'sellerMeta';
    pluralName: 'seller-metas';
    singularName: 'seller-meta';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    phoneNumbers: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    sellerDescription: Schema.Attribute.Text;
    sellerEntity: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    specialisation: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    buyerOrders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    certificates: Schema.Attribute.Relation<
      'oneToMany',
      'api::certificate.certificate'
    >;
    ...
    > &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.Relation<
      'oneToOne',
      'api::seller-meta.seller-meta'
    >;
    password: Schema.Attribute.Password &
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    sellerOrders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
